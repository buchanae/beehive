...
class MajorDomoBroker(object):
    ...
    def process_client(self, sender, msg):
        ...
        # TODO reusable message validation 
        ...
        if service_name.startswith(self.INTERNAL_SERVICE_PREFIX):
            ...
            # TODO should be moved to dispatch?
    ...
    def process_worker(self, sender, msg):
        ...
        # TODO move opcode handling to inproc pub/sub
        #      or, move most opcodes to management services
        if MDP.W_READY == command:
            ...
            if worker_ready or service.startswith(self.INTERNAL_SERVICE_PREFIX):
                # TODO wut? oh, because it's sending two ready signals?
                #      so we delete it?
                self.delete_worker(worker, True)
            else:
                # Attach worker to service and mark as idle
                worker.service = self.services[service_name]
    ...
    def require_worker(self, address):
        ...
        # TODO how can you create a worker? seems odd.
    ...
    def dispatch(self, service, msg):
        ...
        while service.waiting and service.requests:
            # TODO move to Service.handle_something_or_other
